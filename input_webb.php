...
<h4> <br>國小導師點選
    <br>
    <br>
     年級： <input value="一年" name="grade" type="radio">一年級
        <input value="二年" name="grade" type="radio" checked>二年級
        ...
        班別： <input value="一班" name="class" type="radio">一班
       ...
       <br>
        ...
        　　<br>
        姓名：<input required="required" placeholder="請輸入中文姓名" name="name" type="text" value="<?=$_SESSION['cname'];?>"><br>


        　　　<br>
        <br>
        網址： <input placeholder="請輸入網址" name="web" type="text" value="http://"><br></h4>
...
if( $_POST["act"] === "insert"){
    ...
    $sql= "INSERT INTO `weblink` (id, grade, cclass, cname, web, time) VALUES ('NULL','$_POST[grade]','$_POST[class]','$_POST[name]','$_POST[web]',now())";
    $conn = get_conn();
